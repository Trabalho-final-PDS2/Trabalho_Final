...
$(BIN_DIR)/$(TARGET): $(BUILD_DIR)/cadastro.o $(BUILD_DIR)/jogador.o $(BUILD_DIR)/login.o $(BUILD_DIR)/board.o $(BUILD_DIR)/tictactoe.o $(BUILD_DIR)/reversi.o $(BUILD_DIR)/modulo_cadastro.o $(BUILD_DIR)/modulo_jogos.o $(BUILD_DIR)/validacao_entrada.o $(BUILD_DIR)/lig4.o
	$(CC) $(CFLAGS) -o $(BIN_DIR)/$(TARGET) $(BUILD_DIR)/cadastro.o $(BUILD_DIR)/jogador.o $(BUILD_DIR)/login.o $(BUILD_DIR)/board.o $(BUILD_DIR)/tictactoe.o $(BUILD_DIR)/reversi.o $(BUILD_DIR)/modulo_cadastro.o $(BUILD_DIR)/modulo_jogos.o $(BUILD_DIR)/validacao_entrada.o $(BUILD_DIR)/lig4.o
